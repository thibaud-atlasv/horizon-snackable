...
export const FISH_DEFS: IFishDef[] = [
  ...
  // ── Shallow ──────────────────────────────────────────────────────────────────
  { id:  1, name: 'Clownfish',        rarity: 'common',
  ...
  { id:  3, name: 'Blue Discus',      rarity: 'common',
  ...
  { id:  4, name: 'Butterflyfish',    rarity: 'rare',
  ...
  { id:  5, name: 'Angelfish',        rarity: 'rare',
  ...
  { id:  6, name: 'Rainbow Fish',     rarity: 'legendary',
  ...
  // ── Mid ───────────────────────────────────────────────────────────────────────
  { id:  7, name: 'Silver Carp',      rarity: 'common',
  ...
  { id:  8, name: 'Green Discus',     rarity: 'common',
  ...
  { id:  9, name: 'Dolphin',          rarity: 'common',
  ...
  { id: 10, name: 'Flame Angelfish',  rarity: 'rare',
  ...
  { id: 11, name: 'Sand Flounder',    rarity: 'rare',
  ...
  { id: 12, name: 'Sea Turtle',       rarity: 'legendary',
    spawnChance: 0.60, depthMin: -20,
  ...
  // ── Deep ──────────────────────────────────────────────────────────────────────
  { id: 13, name: 'Violet Barracuda', rarity: 'common',
  ...
  { id: 14, name: 'Blue Flounder',    rarity: 'common',
  ...
  { id: 15, name: 'Reef Shark',       rarity: 'common',
  ...
  { id: 16, name: 'Pink Dolphin',     rarity: 'rare',
  ...
  { id: 17, name: 'Barracuda',        rarity: 'rare',
  ...
  { id: 18, name: 'Pink Shark',       rarity: 'legendary',
