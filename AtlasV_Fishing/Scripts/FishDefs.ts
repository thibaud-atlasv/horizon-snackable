...
export const FISH_DEFS: IFishDef[] = [
  ...
  // ── Zone 1 — Shallow ─────────────────────────────────────────────────────────
  { id:  1, name: 'Clownfish',        zone: 1, rarity: 'common',
  ...
  { id:  2, name: 'Koi',              zone: 1, rarity: 'common',
  ...
  { id:  3, name: 'Blue Discus',      zone: 1, rarity: 'common',
  ...
  { id:  4, name: 'Butterflyfish',    zone: 1, rarity: 'rare',
  ...
  { id:  5, name: 'Angelfish',        zone: 1, rarity: 'rare',
  ...
  { id:  6, name: 'Rainbow Fish',     zone: 1, rarity: 'legendary',
  ...
  // ── Zone 2 — Mid ─────────────────────────────────────────────────────────────
  { id:  7, name: 'Silver Carp',      zone: 2, rarity: 'common',
  ...
  { id:  8, name: 'Green Discus',     zone: 2, rarity: 'common',
  ...
  { id:  9, name: 'Dolphin',          zone: 2, rarity: 'common',
  ...
  { id: 10, name: 'Flame Angelfish',  zone: 2, rarity: 'rare',
  ...
  { id: 11, name: 'Sand Flounder',    zone: 2, rarity: 'rare',
  ...
  { id: 12, name: 'Sea Turtle',       zone: 2, rarity: 'legendary',
    spawnChance: 0.60, depthMin: -20,
  ...
  // ── Zone 3 — Deep ─────────────────────────────────────────────────────────────
  { id: 13, name: 'Violet Barracuda', zone: 3, rarity: 'common',
  ...
  { id: 14, name: 'Blue Flounder',    zone: 3, rarity: 'common',
  ...
  { id: 15, name: 'Reef Shark',       zone: 3, rarity: 'common',
  ...
  { id: 16, name: 'Pink Dolphin',     zone: 3, rarity: 'rare',
  ...
  { id: 17, name: 'Barracuda',        zone: 3, rarity: 'rare',
  ...
  { id: 18, name: 'Pink Shark',       zone: 3, rarity: 'legendary',
