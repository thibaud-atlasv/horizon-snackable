...
export const CONVEYOR_MIN_GAP     = 1.4;     // minimum distance between two products on belt

// ---------------------------------------------------------------------------
// Warehouse
// ---------------------------------------------------------------------------
export const WAREHOUSE_BASE_CAPACITY = 3;
...
export const TRUCK_SPEED           = 1.6;  // world units per second (constant across all phases)
...
// Economy
// ---------------------------------------------------------------------------
export const MONEY_PER_PRODUCT = 20;
