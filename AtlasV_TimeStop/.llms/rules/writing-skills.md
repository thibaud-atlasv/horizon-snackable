---
oncalls: ['bigboxvr_infra']
apply_to_content: "Assistant/skills/**/*.md"
---

# Skill authoring best practices
Always apply Antrhopic's best practices to the skill markdown files recursively in /Assistant/skills/

Do rename the file to ensure it matches gerund form as well

Do NOT rename "summary" to "description" in skill file headers - keep "summary" as our skills system relies on this
